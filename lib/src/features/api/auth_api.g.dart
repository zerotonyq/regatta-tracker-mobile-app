...
class _AuthApi implements AuthApi {
  ...
  Future<AuthTokensResponseDto> login(
    ...
    final _headers = <String, dynamic>{r'X-Correlation-ID': correlationId};
    _headers.removeWhere((k, v) => v == null);
    final _data = <String, dynamic>{};
    _data.addAll(request.toJson());
    final _options = _setStreamType<AuthTokensResponseDto>(
    ...
    late AuthTokensResponseDto _value;
    try {
      _value = AuthTokensResponseDto.fromJson(_result.data!);
    } on Object catch (e, s) {
